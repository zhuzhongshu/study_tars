...
namespace Test
{
    ...
    public:
        ...
        BServantPrxCallbackPromise(const promise::Promise< BServantPrxCallbackPromise::PromisetestCoroParallelPtr > &promise)
        ...
        virtual void callback_testCoroParallel_exception(tars::Int32 ret)
        {
            ...
            str += TC_Common::tostr(ret);
            _promise_testCoroParallel.setException(promise::copyException(str, ret));
        }

    protected:
        promise::Promise< BServantPrxCallbackPromise::PromisetestCoroParallelPtr > _promise_testCoroParallel;
    ...
    public:
        ...
        BServantPrxCallbackPromise(const promise::Promise< BServantPrxCallbackPromise::PromisetestCoroSerialPtr > &promise)
        ...
        virtual void callback_testCoroSerial_exception(tars::Int32 ret)
        {
            ...
            str += TC_Common::tostr(ret);
            _promise_testCoroSerial.setException(promise::copyException(str, ret));
        }

    protected:
        promise::Promise< BServantPrxCallbackPromise::PromisetestCoroSerialPtr > _promise_testCoroSerial;
    ...
    public:
        ...
        tars::Int32 testCoroParallel(const std::string & sIn,std::string &sOut,const map<string, string> &context = TARS_CONTEXT(),map<string, string> * pResponseContext = NULL)
        {
            ...
            tars::ResponsePacket rep;
            std::map<string, string> _mStatus;
            tars_invoke(tars::TARSNORMAL,"testCoroParallel", _os.getByteBuffer(), context, _mStatus, rep);
            if(pResponseContext)
            {
                *pResponseContext = rep.context;
            }
        ...
        void async_testCoroParallel(BServantPrxCallbackPtr callback,const std::string &sIn,const map<string, string>& context = TARS_CONTEXT())
        {
            ...
            _os.write(sIn, 1);
            std::map<string, string> _mStatus;
            tars_invoke_async(tars::TARSNORMAL,"testCoroParallel", _os.getByteBuffer(), context, _mStatus, callback);
        }
        
        promise::Future< BServantPrxCallbackPromise::PromisetestCoroParallelPtr > promise_async_testCoroParallel(const std::string &sIn,const map<string, string>& context)
        {
            promise::Promise< BServantPrxCallbackPromise::PromisetestCoroParallelPtr > promise;
            BServantPrxCallbackPromisePtr callback = new BServantPrxCallbackPromise(promise);
        ...
        void coro_testCoroParallel(BServantCoroPrxCallbackPtr callback,const std::string &sIn,const map<string, string>& context = TARS_CONTEXT())
        {
            ...
            _os.write(sIn, 1);
            std::map<string, string> _mStatus;
            tars_invoke_async(tars::TARSNORMAL,"testCoroParallel", _os.getByteBuffer(), context, _mStatus, callback, true);
        }
        ...
        tars::Int32 testCoroSerial(const std::string & sIn,std::string &sOut,const map<string, string> &context = TARS_CONTEXT(),map<string, string> * pResponseContext = NULL)
        {
            ...
            tars::ResponsePacket rep;
            std::map<string, string> _mStatus;
            tars_invoke(tars::TARSNORMAL,"testCoroSerial", _os.getByteBuffer(), context, _mStatus, rep);
            if(pResponseContext)
            {
                *pResponseContext = rep.context;
            }
        ...
        void async_testCoroSerial(BServantPrxCallbackPtr callback,const std::string &sIn,const map<string, string>& context = TARS_CONTEXT())
        {
            ...
            _os.write(sIn, 1);
            std::map<string, string> _mStatus;
            tars_invoke_async(tars::TARSNORMAL,"testCoroSerial", _os.getByteBuffer(), context, _mStatus, callback);
        }
        
        promise::Future< BServantPrxCallbackPromise::PromisetestCoroSerialPtr > promise_async_testCoroSerial(const std::string &sIn,const map<string, string>& context)
        {
            promise::Promise< BServantPrxCallbackPromise::PromisetestCoroSerialPtr > promise;
            BServantPrxCallbackPromisePtr callback = new BServantPrxCallbackPromise(promise);
        ...
        void coro_testCoroSerial(BServantCoroPrxCallbackPtr callback,const std::string &sIn,const map<string, string>& context = TARS_CONTEXT())
        {
            ...
            _os.write(sIn, 1);
            std::map<string, string> _mStatus;
            tars_invoke_async(tars::TARSNORMAL,"testCoroSerial", _os.getByteBuffer(), context, _mStatus, callback, true);
        }
