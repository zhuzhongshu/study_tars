...
namespace Test
{
    ...
    public:
        virtual int onDispatch(tars::ReqMessagePtr msg)
        {
            ...
            pair<string*, string*> r = equal_range(__BServant_all, __BServant_all+1, string(msg->request.sFuncName));
    ...
    public:
        ...
        typedef tars::TC_AutoPtr< BServantPrxCallbackPromise::PromisequeryResult > PromisequeryResultPtr;

        BServantPrxCallbackPromise(const promise::Promise< BServantPrxCallbackPromise::PromisequeryResultPtr > &promise)
        : _promise_queryResult(promise)
        {}
        
        virtual void callback_queryResult(const BServantPrxCallbackPromise::PromisequeryResultPtr &ptr)
        {
    ...
    protected:
        promise::Promise< BServantPrxCallbackPromise::PromisequeryResultPtr > _promise_queryResult;
        ...
        virtual int onDispatch(tars::ReqMessagePtr msg)
        {
            ...
            switch(r.first - __BServant_all)
            {
                case 0:
                {
                    ...
                    BServantPrxCallbackPromise::PromisequeryResultPtr ptr = new BServantPrxCallbackPromise::PromisequeryResult();
    ...
    public:
        ...
        void async_queryResult(BServantPrxCallbackPtr callback,const std::string &sIn,const map<string, string>& context = TARS_CONTEXT())
        {
            tars::TarsOutputStream<tars::BufferWriter> _os;
            _os.write(sIn, 1);
            std::map<string, string> _mStatus;
        ...
        promise::Future< BServantPrxCallbackPromise::PromisequeryResultPtr > promise_async_queryResult(const std::string &sIn,const map<string, string>& context)
        {
            promise::Promise< BServantPrxCallbackPromise::PromisequeryResultPtr > promise;
        ...
        void coro_queryResult(BServantCoroPrxCallbackPtr callback,const std::string &sIn,const map<string, string>& context = TARS_CONTEXT())
        {
            tars::TarsOutputStream<tars::BufferWriter> _os;
            _os.write(sIn, 1);
            std::map<string, string> _mStatus;
    ...
    public:
        int onDispatch(tars::TarsCurrentPtr _current, vector<char> &_sResponseBuffer)
        {
            ...
            pair<string*, string*> r = equal_range(__Test__BServant_all, __Test__BServant_all+1, _current->getFuncName());
            if(r.first == r.second) return tars::TARSSERVERNOFUNCERR;
